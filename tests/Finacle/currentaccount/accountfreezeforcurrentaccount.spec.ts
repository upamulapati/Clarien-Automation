...
// Existing current account on which the freeze is marked.
...
// HAFSM - Mark a total freeze on an existing current account.
test('HAFSM - mark total freeze on current account', async ({ page }) => {
