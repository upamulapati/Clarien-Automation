...
// Existing current account on which the freeze was marked.
...
// HAFSM - Verify/authorise the freeze that was marked on a current account.
test('HAFSM - verify freeze on current account', async ({ page }) => {
