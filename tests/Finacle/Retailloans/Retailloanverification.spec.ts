...
const SHARED_LOAN_ACCOUNT = getSharedValue<string>(state => (state as any).loanAccountId);
const LOAN_ACCOUNT_NUMBER = SHARED_LOAN_ACCOUNT ?? '3200000044';
...
test('HOAACVLA - verify retail loan account', async ({ page }) => {
  ...
  expect(verifiedAccountNumber, '===').toBeTruthy();
