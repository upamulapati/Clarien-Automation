...
test.describe('Verify Related Party for Retail Loan Account', () => {
  ...
  // HACMLA - Verify/authorise the related party that was added to a retail loan account
  test('HACMLA - verify added related party for retail loan account', async ({ page }) => {
    ...
    // Step 9: Visit Related Party details - go to the 2nd record (newly added party)
    ...
    // Step 14: Click Submit - the added related party gets authorised/verified
