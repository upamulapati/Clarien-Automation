...
const CREDIT_ACCOUNT = '9200000596'// '7500001474';  // SB/CA account to be credited
const AMOUNT = '1000';
...
test('HTM - transfer maintenance (post by part transaction)', async ({ page }) => {
  ...
  // Service pack validation - HACLINQ account ledger inquiry.
  console.log('Running service pack HACLINQ validation...');
  const spPage = new ServicePackPage(page);
  await spPage.servicePackAccountLedgerInquiryValidation({
    accountId: '500USD2297007',
