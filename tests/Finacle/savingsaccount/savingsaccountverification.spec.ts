...
// TC_SB_HACM_VERIFY_001 - HACM Account Maintenance - Verify/Authorise modification
test('HACM - verify account modification', async ({ page }) => {
  ...
  // Step 10b: Document tab is mandatory, else Submit is blocked with
